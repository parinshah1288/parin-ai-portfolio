...
At Intel, I worked on enterprise-scale data platforms, ETL systems, APIs, and real-time streaming architectures. My work included building systems capable of processing petabytes of data, supporting advanced analytics workflows, and driving measurable business impact.

I am currently pursuing graduate studies in Artificial Intelligence and Machine Learning at Indiana Wesleyan University. My goal is to combine my background in large-scale systems and data engineering with modern AI technologies to build intelligent platforms that solve real-world problems.
